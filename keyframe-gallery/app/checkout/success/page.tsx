        ...
        <div className="space-y-12">
          ...
          <div className="space-y-8">
            {[
              {
                title: "Material",
                desc: "Sourced from high-grade 6063 aerospace aluminum blocks.",
              },
              {
                title: "Precision",
                desc: "CNC milled with a tolerance of 0.01mm for absolute fit.",
              },
              {
                title: "Acoustics",
                desc: "Internal chambers tuned specifically for lower-frequency thocks.",
              },
            ].map((item, idx) => (
              <div
                key={idx}
                className="space-y-2 border-l-2 border-text-primary/10 pl-6 hover:border-text-primary transition-colors"
              >
